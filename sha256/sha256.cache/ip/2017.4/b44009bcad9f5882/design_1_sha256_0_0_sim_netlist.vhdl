...
\FSM_sequential_s_state[2]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"22200000"
    )
        port map (
...
\iteration[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAA9AA8"
    )
        port map (
...
\iteration[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAA6AAAAA0"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sha256_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \slv_reg18[31]_i_3\ : label is "soft_lutpair2";
begin
