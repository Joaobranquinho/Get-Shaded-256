...
HD_PWD='/home/brancs/MEOCloud/CR/Get-Shaded-256/sha256/sha256.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sha256_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sha256_wrapper.tcl -notrace
