...
HD_PWD='/home/brancs/MEOCloud/CR/Get-Shaded-256/sha256/sha256.runs/sha256_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sha256_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sha256_axi_gpio_0_0.tcl
