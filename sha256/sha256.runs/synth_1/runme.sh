...
HD_PWD='/home/brancs/MEOCloud/CR/Get-Shaded-256/sha256/sha256.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sha256_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sha256_wrapper.tcl
