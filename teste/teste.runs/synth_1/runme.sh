...
HD_PWD='/home/brancs/MEOCloud/CR/Get-Shaded-256/teste/teste.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sha_hw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sha_hw.tcl
