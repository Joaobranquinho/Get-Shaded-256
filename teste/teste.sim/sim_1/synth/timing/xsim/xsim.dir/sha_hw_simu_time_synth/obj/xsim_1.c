...
{
	iki_sensitize(dp, "xsim.dir/sha_hw_simu_time_synth/xsim.reloc");
}

void simulate(char *dp)
{
	iki_schedule_processes_at_time_zero(dp, "xsim.dir/sha_hw_simu_time_synth/xsim.reloc");
	// Initialize Verilog nets in mixed simulation, for the cases when the value at time 0 should be propagated from the mixed language Vhdl net

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 191936, dp + 193320, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 191992, dp + 193376, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 192160, dp + 193264, 0, 511, 0, 511, 512, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 192048, dp + 193208, 0, 0, 0, 0, 1, 1);
...
int main(int argc, char **argv)
{
    ...
    iki_set_sv_type_file_path_name("xsim.dir/sha_hw_simu_time_synth/xsim.svtype");
    iki_set_crvs_dump_file_path_name("xsim.dir/sha_hw_simu_time_synth/xsim.crvsdump");
    void* design_handle = iki_create_design("xsim.dir/sha_hw_simu_time_synth/xsim.mem", (void *)relocate, (void *)sensitize, (void *)simulate, 0, isimBridge_getWdbWriter(), 0, argc, argv);
